  ...
  errorMessage
                ...
                return (
                    <div className='space-y-4'>
                        ...
                        <div className="bg-red-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm text-gray-900">{safeErrorMessage || "An unexpected error occurred while processing your order."}</p>
                        </div>
    ...
    return (
        ...
        {!isProcessing && (
            <ModalFooter>
            <button
                className={`${hasError ? 'bg-red-600 hover:bg-red-700' : 'bg-fuchsia-600 hover:bg-fuchsia-700'} text-white px-4 py-2 rounded-lg`}
                onClick={onClose}
            >
